# The file seems to have multiple "except Exception as e:"
# I will completely rewrite the block from 'if st.button("✅ Valider et Enregistrer"'
import re
...
# We just fix the whole thing properly indented
...
# First attempt exact replace
if old_block in content:
    content = content.replace(old_block, new_block)
    with open("app.py", "w") as f:
        f.write(content)
    print("Success exact replace")
else:
    print("Failed exact replace, trying manual search")
